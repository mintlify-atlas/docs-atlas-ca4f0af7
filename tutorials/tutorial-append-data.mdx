...
This tutorial shows you how to use the Apache Druid SQL [INSERT](/multi-stage-query/reference#insert) function to append data to a [datasource](/design/storage) without changing the existing data. The examples in the tutorial use the [multi-stage query (MSQ)](/multi-stage-query) task engine to executes SQL statements.
...
Load a sample dataset using [INSERT](/multi-stage-query/reference#insert) and [EXTERN](/multi-stage-query/reference#extern-function) functions. The EXTERN function lets you read external data or write to an external location.
...
<Step title="Run the append query">
...
<Step title="View the appended data">
...
- [SQL-based ingestion reference](/multi-stage-query/reference) for a reference on MSQ architecture.
- [SQL-based ingestion query examples](/multi-stage-query/examples) for example queries using the MSQ task engine.
