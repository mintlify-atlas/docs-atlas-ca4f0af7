...
description: Learn how to configure retention rules in Apache Druid to manage data lifecycle
---
...
For this tutorial, we'll assume you've already downloaded Apache Druid as described in the [single-machine quickstart](./index) and have it running on your local machine.

It will also be helpful to have finished [Load a file](../tutorials/tutorial-batch) and [Query data](../tutorials/tutorial-query) tutorials.
...
<Step title="View the datasources">
...
![Summary](/assets/tutorial-retention-01.png)
...
![Original segments](/assets/tutorial-retention-02.png)
</Step>
...
<Step title="Open rule configuration">
...
![Rule configuration](/assets/tutorial-retention-03.png)
</Step>

<Step title="Add new rules">
...
![Set rules](/assets/tutorial-retention-04.png)
</Step>

<Step title="Save the rules">
...
![New rules](/assets/tutorial-retention-05.png)
</Step>

<Step title="Monitor segment changes">
Give the cluster a few minutes to apply the rule change, and go to the [segments view](http://localhost:8888/unified-console.html#segments) in the web console. The segments for the first 12 hours of 2015-09-12 are now gone:

![New segments](/assets/tutorial-retention-06.png)
</Step>

</Steps>

## Understanding the retention rule chain
...
- [Load rules](/operations/rule-configuration)
